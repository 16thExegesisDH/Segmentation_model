...
| Identifier | files_identifier | Resp | files number | Author | Title | Printer | Date | Place | Library | Call number (digital) |
|-----------|------------------|------|--------------|--------|-------|---------|------|-------|---------|-----------------------|
...
| Cajetan_1-Tim_001 | bsb10143002_00312-bsb10143002_00317 | FG | 6 | Thomas Cajetan | — | Giunta, Luca Antonio | 1531 | Venice | Bayerische Staatsbibliothek München | [2 Exeg. 610](https://mdz-nbn-resolving.de/urn:nbn:de:bvb:12-bsb10143002-9) |
